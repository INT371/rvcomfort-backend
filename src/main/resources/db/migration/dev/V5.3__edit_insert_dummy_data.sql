...
INSERT INTO `rvcomfort`.`room_type` (type_id, type_name, description, price, max_capacity, policy, created_at,
                                     updated_at)
VALUES (0, 'Regular A', 'Regular type A', 400.00, 2, 'benefits', NOW(), null),
       (0, 'Regular B', 'Regular type B', 500.00, 2, 'benefits', NOW(), null),
       (0, 'Regular C', 'Regular type C', 550.00, 2, 'benefits', NOW(), null),
