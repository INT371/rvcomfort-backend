...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (request.getServletPath().equals("/api/login") || request.getServletPath().equals("/api/v1/user") || request.getServletPath().contains("/api/user/token/refresh")
                ...
                && request.getMethod().equals("GET"))) { // TODO: Change endpoint to skip filtering
